...
In [Unit 5](../../4-adding-crud-pages/antd/add-list-page.md), you will learn how to create CRUD pages manually using the code generated by Inferencer as a reference.
