...
If you’d like to deploy to Netlify, skip to [Deploy your app to the web](../1-getting-started/5-deploy-project.md). Otherwise, skip to [Generate CRUD pages automatically with Inferencer](!!!!!!!) to start building with **refine**!
